...
count2 = 0
thread = 1
dataset1 = open('data_concurrent_hash_read_0.5.csv', 'r')
dataset2 = open('data_syncchronized_map_read_0.5.csv', 'r')
...
plt.title('Grafico para operação de leitura, usando 0.5 de carga na operação')
