...
dataset1 = open('data_t1_p0.2_op1000.csv', 'r')
dataset2 = open('data_t2_p0.2_op1000.csv', 'r')
dataset3 = open('data_t4_p0.2_op1000.csv', 'r')
dataset4 = open('data_t8_p0.2_op1000.csv', 'r')
dataset5 = open('data_t16_p0.2_op1000.csv', 'r')
dataset6 = open('data_t32_p0.2_op1000.csv', 'r')
dataset7 = open('data_t64_p0.2_op1000.csv', 'r')
dataset8 = open('data_t128_p0.2_op1000.csv', 'r')

for line in dataset1:
    line = line.strip()
    A,B,C,D,E,F = line.split(',')
    if (A == "CopyOnWriteArrayList" and E == "write"):
        sum1 +=int(F)
        count+=1
    if (A == "SynchronizedList" and E == "write"):
        sum2 +=int(F)
        count2+=1
    if (count == 200) :
        x.append(B)
