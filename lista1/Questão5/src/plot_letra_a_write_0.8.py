...
dataset1 = open('data_concurrent_hash_write_0.8.csv', 'r')
dataset2 = open('data_syncchronized_map_write_0.8.csv', 'r')
...
plt.title('Grafico para operação de escrita, usando 0.8 de carga na operação')
