#!/bin/bash
#Script feito para execução da resolução da questão 5, letra b  - lista 1 - Programação Concorrente
...
#Comando é: java  -classpath . letraA.Main qtdthreads cargaoperacoes qtdoperacoes
for i in $(seq 1 8) ; do
    java  -classpath . letraB.Main $THREADS 0.5 1000
    THREADS=$[$THREADS*2]
done
